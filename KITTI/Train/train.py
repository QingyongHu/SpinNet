...
sys.path.append('../../')
from KITTI.Train.dataloader import get_dataloader
from KITTI.Train.trainer import Trainer
...
class Args(object):
    def __init__(self):
        ...
        self.epoch = 20
        self.num_patches = 10
        self.num_points_per_patch = 2048  # num of points per patches
        self.batch_size = 60
        self.rad_n = 9
        self.azi_n = 60
        self.ele_n = 30
        ...
        self.dataset = 'KITTI'
        self.data_train_dir = '../../data/KITTI/patches'
        self.data_val_dir = '../../data/KITTI/patches'
